...
const formatDisplayDate = (dateString) => {
  ...
  const data = parse(dateString, "yyyy-MM", new Date());
...
export default function EntryForm({ type, entries, onChange=()=>{} }) {
  ...
  useEffect(() => {
    if (!isImproving && !improveError && watch("description")) {
      setValue("description", improvedContent?.improvedContext);
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className=" grid grid-cols-2 gap-4">
              ...
              <div className=" space-y-2">
                <Input
                  placeholder="Organization/Comapany"
